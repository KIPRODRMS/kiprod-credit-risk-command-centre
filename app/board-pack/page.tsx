          ...
          <div className="space-y-6">
            <section className="board-report-prepared" aria-label="Board paper preparation details">
              <div>
                ...
                <strong>Board / Board Risk Committee</strong>
              </div>
              <div>
                <span>Prepared By</span>
                <strong>Management / Credit Risk Function</strong>
              </div>
              <div>
                <span>Generated By</span>
                <strong>KIPROD Command Centre</strong>
              </div>
              <div>
                <span>Reporting Period</span>
                <strong>{profile.reportingMonth || "Profile pending"}</strong>
              </div>
              <div>
                <span>Confidentiality</span>
                <strong>Board Use Only</strong>
              </div>
            </section>
            ...
            <section className="board-report-section board-report-appendix">
              ...
              <p className="board-report-appendix-note mt-4">
                {appendixGovernanceNote}
              </p>
              <form
              ...
              <div className="board-report-print-register hidden print:block">
                {appendixGroups.map((group) => (
                  <div key={group.status} className="board-report-risk-group">
                    <h3 className="board-report-risk-group-title">
                      {group.title} · {group.rows.length} accounts
                    </h3>
