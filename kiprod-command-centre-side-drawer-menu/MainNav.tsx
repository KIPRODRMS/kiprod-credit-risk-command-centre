  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-800 bg-slate-950 text-white shadow-lg shadow-slate-950/10">
      ...
      <button
        ...
        className={`fixed inset-0 z-[60] bg-slate-950/55 backdrop-blur-sm transition-all duration-300 2xl:hidden ${
      ...
      <aside
        ...
        aria-hidden={!open}
        className={`fixed inset-y-0 right-0 z-[70] flex w-[min(88vw,420px)] flex-col border-l border-slate-700 bg-slate-950 shadow-2xl shadow-black/50 transition-transform duration-300 ease-out 2xl:hidden ${
